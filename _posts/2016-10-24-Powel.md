...
- [Dependency Inversion Principle](https://en.wikipedia.org/wiki/Dependency_inversion_principle): Essentially, the use of “new()” is banned. All dependencies are resolved using an IoC container. Otherwise, test-driven approaches are impossible.
